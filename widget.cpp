...
Widget::Widget(QWidget *parent) :
    QWidget(parent),
    m_pQmlContainer(0),
    m_shadow("qrc:/i/window_shadow.png")
{
...
{
    m_pQmlContainer->setSource(QUrl("qrc:/qmlmain.qml"));
    return true;
//    if ( QFile::exists(qmlFile) )
//    {
//        //m_pQmlContainer->setSource(QUrl(qmlFile));
//        m_pQmlContainer->setSource(QUrl(":/qmlmain.qml"));
//        return true;
//    }
//    else
//    {
