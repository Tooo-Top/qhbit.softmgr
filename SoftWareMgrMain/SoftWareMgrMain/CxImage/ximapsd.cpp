...
namespace MyPSD
{
	...
	class CPSD
	{
		struct HEADER_INFO
		{
			...
			//								They are full unsigned 16每bit values as in Apple＊s RGBColor data
			//								structure. Pure red=65535,0,0.
			//		4		CMYK			The four values in the color data are cyan, magenta, yellow, and
			//								black. They are full unsigned 16每bit values. 0=100% ink. Pure
			...
			//								and b chrominance.
			//								Lightness is a 16每bit value from 0...100. The chromanance components
			//								are each 16每bit values from 每128...127. Gray values
		...
		struct DISPLAY_INFO
		{
			...
			//							brightness. They are full unsigned 16每bit values as in Apple＊s
			...
			//							and b chrominance.
			//							Lightness is a 16每bit value from 0...10000. The chromanance components
			//							are each 16每bit values from 每12800...12700. Gray values
			//							are represented by chrominance components of 0. Pure
			//							white=10000,0,0.
		...
		struct THUMBNAIL
		{
			...
			// Table 2每5: Thumnail resource header
			//	Type		Name		Description
			//-------------------------------------------
...
namespace MyPSD
{
	...
	bool CPSD::ReadColourModeData(CxFile &pFile, COLOUR_MODE_DATA& colour_mode_data)
	{
		...
		// will contain the color table for the image, in non每interleaved order.
